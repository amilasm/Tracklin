                ...
                <tr className="bg-white border-b">
                  ...
                  <td className="px-6 py-4 gap-0 flex">
                    ...
                    <button
                      ...
                      class="focus:outline-none text-white bg-green-500 hover:bg-green-500 focus:ring-4 focus:ring-green-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-500 dark:hover:bg-green-400 dark:focus:ring-red-900"
                    >
